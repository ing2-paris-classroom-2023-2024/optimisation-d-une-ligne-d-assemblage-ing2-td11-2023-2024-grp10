...
// Structure pour représenter une paire d'opérations interdites ce qui est très important
typedef struct {   
    int op1;
    int op2;
} Exclusion;

// C'est une tructure qui permet de représenter le graphe orienté sans cycle (acyclique)
typedef struct {
